...
export const ExpenseContext = createContext({
  //define the shape of my context
  expenses: [],
...
function expenseReducer(state, action) {
  switch (action.type) {
    ...
    case "UPDATE":
      ...
      const updatedExpensees = [...state];
      updatedExpensees[updatableExpenseIndex] = updatedItem;
      return updatedExpensees;
    case "DELETE":
...
function ExpenseContextProvider({ children }) {
  //add the state management logic
